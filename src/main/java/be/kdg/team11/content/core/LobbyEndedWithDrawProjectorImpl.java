...
@Service
@Transactional
public class LobbyEndedWithDrawProjectorImpl implements LobbyEndedWithDrawProjector {
    ...
    public LobbyEndedWithDrawProjectorImpl(LoadPlayerStatisticsPort loadPlayerStatisticsPort, List<SavePlayerStatisticsPort> savePlayerStatisticsPorts, LoadPlatformAchievementPort loadPlatformAchievementPort) {
    ...
    @Override
    public void project(LobbyEndedWithDrawCommand command) {
